#!/bin/tcsh
foreach DATASET ("politifact/" "pheme/")
    set NEAREST_NEIGHBOR_K=7
    set LABEL_KINDS=2
    set EPOCHS=300
    ...
    python3 HMGNN.py --label_kinds $LABEL_KINDS --epochs $EPOCHS --data_dir $DATA_DIR --model_dir $MODEL_DIR \
        --feature_dim $FEATURE_DIM --nearest_neighbor_K $NEAREST_NEIGHBOR_K --model_name $MODEL_NAME --model_version 1
end
